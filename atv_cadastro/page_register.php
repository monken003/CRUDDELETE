...
<body>
    ...
    <button class= "btn btn-primary btn-Ig" type= "submit" name="butao">Cadastrar </button>
...
<?php
 ...
 if(isset($_POST["butao"])){
     $conexao->executeQuery("insert into cliente values(null,'".$_POST["nome"]."','".$_POST["email"]."','".$_POST["cpf"]."', '2020-10-08' ,
